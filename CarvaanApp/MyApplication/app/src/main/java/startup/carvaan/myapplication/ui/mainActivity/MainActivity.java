...
import startup.carvaan.myapplication.ui.start.SplashScreen;
...
public class MainActivity extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    private void gotoLoginActivity() {
        Intent logIntent = new Intent(MainActivity.this, SplashScreen.class);
    ...
    protected void onStop() {
        ...
        new MaterialTapTargetSequence()
                .addPrompt(new MaterialTapTargetPrompt.Builder(MainActivity.this)
                        ...
                        .setSecondaryText("Welcome to this app ,If you want to know all things about this app and how to operate it then go to the How to play page in side drawer")
                        .create(), 4000)
                .addPrompt(new MaterialTapTargetPrompt.Builder(MainActivity.this)
                        .setTarget(findViewById(R.id.n1))
                        .setPrimaryText("This is all shares page ")
